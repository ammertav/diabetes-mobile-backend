...
@section('content')
    ...
    <div x-data="{
        ...
        <form id="delete-form" method="POST" class="hidden" x-ref="deleteForm"
        ...
        <div x-show="showDeleteModal"
            ...
            <div @click.away="showDeleteModal = false"
                ...
                <!-- Warning Icon -->
                <div
                    class="w-12 h-12 rounded-full bg-tertiary/10 text-tertiary flex items-center justify-center mb-4">
                    <span class="material-symbols-outlined text-2xl"
                        data-weight="fill">warning</span>
                </div>

                <!-- Title & Description -->
                <h3 class="text-lg font-bold text-on-surface mb-2 font-headline">
                    Hapus Protokol?</h3>
                <p class="text-xs text-on-surface-variant mb-6 leading-relaxed">
                    Apakah Anda yakin ingin menghapus protokol puasa ini? Tindakan
    ...
    <a href="{{ route('fasting-protocols-create') }}"
        ...
        <span
            class="material-symbols-outlined text-2xl group-hover:rotate-90 transition-transform duration-300">add</span>
