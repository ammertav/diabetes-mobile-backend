...
@section('content')
    ...
    <div x-data="{
        ...
        <!-- Full-Width Protocol Filter Bar -->
        @include('fasting-protocol.partials._filters')
        ...
        <div x-show="showDeleteModal"
            ...
            <div @click.away="showDeleteModal = false"
                ...
                <h3 class="text-lg font-bold text-slate-900 mb-2 font-headline">Hapus Protokol?</h3>
